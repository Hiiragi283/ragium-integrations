...
class HTRockGeneratorCategory(key: HTMachineKey) : HTMachineCategoryBase(key) {
    override fun arrangeSlots(display: HTMachineRecipeDisplay, bounds: Rectangle, consumer: Consumer<Widget>) {
        ...
        createSlot(consumer, bounds, 2, 0, display.catalyst, true)
        // outputs
        createSlot(consumer, bounds, 5, 0, display.getItemInput(0), false)
    }
