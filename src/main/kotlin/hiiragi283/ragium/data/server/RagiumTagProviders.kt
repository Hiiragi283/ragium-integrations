...
object RagiumTagProviders {
    ...
    private class FluidProvider(output: FabricDataOutput, registryLookup: CompletableFuture<RegistryWrapper.WrapperLookup>) :
        ...
        override fun configure(wrapperLookup: RegistryWrapper.WrapperLookup) {
            ...
            add(ConventionalFluidTags.GASEOUS, RagiumFluids.AMMONIA)
            ...
            add(ConventionalFluidTags.GASEOUS, RagiumFluids.SULFUR_DIOXIDE)
            add(ConventionalFluidTags.GASEOUS, RagiumFluids.SULFUR_TRIOXIDE)
